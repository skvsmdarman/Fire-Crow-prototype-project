...
import styles from "../terms/policy-tabs.module.css";
...
export default function PrivacyPolicyPage() {
  ...
  // Filter privacy clauses: show global clauses + clauses matching the selected region
  const activeClauses = PRIVACY_SECTIONS.filter(
  ...
  return (
    <main className="legal-shell">
      ...
      <section className="legal-hero">
        <div className="section-kicker">Privacy Operations</div>
        <h1>Privacy Policy</h1>
        <p>
          Detailing how our platform processes manifests, audit targets, and logs in compliance with global standards.
        </p>
        ...
        <div className={styles.timezoneBanner}>
          <div className={styles.bannerLeft}>
            ...
            <div className={styles.bannerText}>
              We detected your timezone is <strong>{timezone}</strong>. We have loaded policy statements compliant with
              {" "}
              <strong>{detectedRegionOption.name}</strong> privacy standards ({detectedRegionOption.badge}).
            </div>
          </div>
      ...
      <div className={styles.tabBar} role="tablist" aria-label="Regional privacy standards">
