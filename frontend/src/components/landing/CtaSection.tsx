          ...
          <div className={styles.ctaActions}>
            <div className={styles.oauthButtons}>
              {providerAvailability.github && (
                <a href={getOauthHref("github")} className={styles.oauthButton}>
                  ...
                  <span>Audit with GitHub</span>
                </a>
              )}
              {providerAvailability.google && (
                <a href={getOauthHref("google")} className={`${styles.oauthButton} ${styles.google}`}>
                  ...
                  <span>Audit with Google</span>
                </a>
              )}
            </div>
            <button onClick={onEnter} className={styles.passwordButton}>
